...
class EmailService(private val mailSender: JavaMailSender) {
    ...
    @Async
    fun sendPasswordResetEmail(to: String, name: String, resetLink: String) {
        try {
            ...
            log.error("Failed to send password reset email to {}: {}", to, e.message)
        } catch (e: Exception) {
            log.error("Unexpected error sending password reset email to {}: {}", to, e.message)
        }
    }

    private fun buildPasswordResetHtml(name: String, resetLink: String): String = """
        <!DOCTYPE html>
        <html>
              ...
              <table width="520" cellpadding="0" cellspacing="0"
                ...
                <tr><td>
                  ...
                  <p style="font-size:15px;color:#333;line-height:1.6;margin:0 0 24px;">
                    We received a request to reset your Docodile password. Click the button below to
