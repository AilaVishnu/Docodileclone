...
class PatientController(
    ...
    private val patientDepositService: com.example.docodile.service.PatientDepositService,
    private val billService: com.example.docodile.service.BillService,
    ...
    fun billFooter(@PathVariable patientId: UUID): ResponseEntity<Any> {
        ...
        val lastPaid = appointmentRepository
            .findPaidByPatient(clinicId, patientId, PageRequest.of(0, 1))
            .firstOrNull()
