...
const CATALOG: {
  ...
  },
  {
    ...
    items: [
      ...
      { msg: 'Sent to doctor · Inventory updated', type: 'success', concept: 'inventory' },
      { msg: 'Sent to doctor · Short stock on: Paracetamol', type: 'warning', concept: 'lowStock' },
      ...
      { msg: 'Sent to doctor · Inventory deduction failed: Network error', type: 'error', concept: 'failed' },
