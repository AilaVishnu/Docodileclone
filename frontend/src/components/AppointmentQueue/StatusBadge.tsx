...
> = {
  ...
  WAITING: { bg: colors.yellow100, color: colors.blindBlack, label: "Waiting" },
  SCHEDULED: { bg: colors.primary200, color: colors.neutral900, label: "Booked" },
  ARRIVED: { bg: colors.primary200, color: colors.blindBlack, label: "Arrived" },
  IN_PROGRESS: { bg: colors.neutral100, color: colors.blindBlack, label: "In Progress" },
